...
export const AVAILABLE_SKILLS: Skill[] = [
  ...
  // ==================== NEW MINDFUL GAMES ====================
  {
    id: 'breathing_orb',
    name: 'Breathing Orb',
    description: 'Guided breathing visualization for mindfulness and relaxation',
    category: 'games',
    emoji: '🔮',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'breakout',
    name: 'Retro Breakout',
    description: 'Classic brick-breaking arcade game with vintage aesthetics',
    category: 'games',
    emoji: '🧱',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'game_2048',
    name: '2048 Puzzle',
    description: 'Sliding number puzzle - combine tiles to reach 2048',
    category: 'games',
    emoji: '🔢',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'memory_match',
    name: 'Memory Match',
    description: 'Card matching memory game with calming themes',
    category: 'games',
    emoji: '🃏',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'water_ripples',
    name: 'Water Ripples',
    description: 'Calming interactive water surface - touch to create ripples',
    category: 'games',
    emoji: '💧',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'sand_flow',
    name: 'Sand Flow',
    description: 'Relaxing falling sand simulation - watch particles flow',
    category: 'games',
    emoji: '⏳',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'space_invaders',
    name: 'Space Invaders',
    description: 'Classic retro arcade shooter - defend Earth from aliens',
    category: 'games',
    emoji: '👾',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'frogger',
    name: 'Frogger',
    description: 'Classic road-crossing game - help the frog get home safely',
    category: 'games',
    emoji: '🐸',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'kinetic_sand',
    name: 'Kinetic Sand',
    description: 'Satisfying digital kinetic sand - drag, poke, and play',
    category: 'games',
    emoji: '🏖️',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'rain_on_window',
    name: 'Rain on Window',
    description: 'Relaxing rain simulation - watch raindrops fall on glass',
    category: 'games',
    emoji: '🌧️',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'kaleidoscope',
    name: 'Kaleidoscope',
    description: 'Mesmerizing symmetrical drawing - create beautiful patterns',
    category: 'games',
    emoji: '🌀',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'maze_walker',
    name: 'Maze Walker',
    description: 'Relaxing maze exploration at your own pace',
    category: 'games',
    emoji: '🌳',
    isPremium: false,
    isUnlocked: true,
  },
  {
    id: 'untangle',
    name: 'Untangle',
    description: 'Relaxing puzzle - drag nodes to eliminate crossing lines',
    category: 'games',
    emoji: '🔗',
    isPremium: false,
    isUnlocked: true,
