...
A comprehensive guide answering common questions about using Mood Leaf.
...
2. [Mood Leaf's Code of Conduct](#mood-leafs-code-of-conduct)
3. [How Mood Leaf Learns](#how-mood-leaf-learns)
4. [Journaling](#journaling)
5. [Chatting with Your Guide](#chatting-with-your-guide)
...
Mood Leaf is a mental health journaling app with an AI companion. It helps you:
...
**No.** Mood Leaf is a journaling companion, not a therapist. It will never:
- Diagnose you with any condition
- Tell you to change medications
- Replace professional mental health care

If you're struggling, Mood Leaf will encourage you to seek professional help.
...
Mood Leaf itself is free. API usage costs depend on how much you chat:
...
## Mood Leaf's Code of Conduct

### What are Mood Leaf's ethical principles?

Mood Leaf follows a strict code of conduct called the **Mood Leaf Ethics**:

#### 1. Never Diagnose
Mood Leaf will **never** label you with mental health conditions. Instead of saying "you have anxiety disorder," it says "you've been mentioning feeling anxious lately." Only qualified professionals can diagnose.

#### 2. Never Prescribe
Mood Leaf will **never** tell you to start, stop, or change medications. It might acknowledge you're taking something, but medication decisions are between you and your doctor.

#### 3. Always Tentative
Mood Leaf uses language like "it seems," "I wonder if," and "you might notice" because only YOU truly know your experience. We never tell you how you feel.
...
#### 5. Privacy First
Your data belongs to you. Everything stays on your device. We can't see your journals, and we don't want to.

#### 6. Encourage Professional Help
For persistent struggles, Mood Leaf always encourages seeking professional support. We're a companion, not a replacement for therapy.

#### 7. Honest & Grounded
Mood Leaf won't give you toxic positivity or empty reassurance. It's honest, grounded, and meets you where you are.

### Why does Mood Leaf have these rules?

Mental health apps can cause harm if they're not careful. We've seen apps that:
- Create unhealthy dependency
- Give dangerous advice
- Make people feel judged
- Violate privacy

Mood Leaf's ethics exist to make sure we help, never harm.

### What if Mood Leaf breaks these rules?

If you ever feel Mood Leaf violated these principles, please let us know. You can shake the device to report feedback, or email us. We take ethics seriously.

---

## How Mood Leaf Learns

### Does Mood Leaf get better the more I use it?

**Yes!** The more you use Mood Leaf, the better it understands you:

#### Week 1
- Learns your name and basic situation
- Starts detecting key people you mention
- Notices your communication preferences

#### Month 1
- Knows key relationships (partner, family, friends, therapist)
- Understands your work/school situation
- Tracks health journey and medications
- Learns what topics matter to you

#### Month 3+
- Sees long-term patterns in your mood
- Knows your coping mechanisms (healthy and unhealthy)
- Understands seasonal/temporal patterns
- Can reference things from months ago

#### With HealthKit (optional)
- Correlates sleep with mood over time
- Notices activity patterns
- Learns your heart rate baseline
- Discovers YOUR personal patterns

### How does Mood Leaf remember things?

Mood Leaf builds a **Life Context** from your journal entries:

1. **Automatic extraction** - Detects people, events, health info, work situations
2. **Pattern recognition** - Notices recurring themes over time
3. **Milestone tracking** - Remembers significant events
4. **Sentiment tracking** - Knows how topics make you feel

This context is stored **only on your device** and used to give you personalized responses.
...
**Generic chatbot:**
> "That sounds stressful. Have you tried deep breathing?"

**Mood Leaf after learning about you:**
> "Work stress again - that's the third time this week you've mentioned your manager. Last time, you said talking to Sarah helped. Have you been able to connect with her?"

The more context Mood Leaf has, the more it can reference YOUR story, YOUR people, and YOUR patterns.

### Can I see what Mood Leaf knows about me?

Yes! Go to **Settings** > **Life Context** to see:
- People Mood Leaf has detected
- Topics and themes tracked
...
### Does using the app more cost more?

Using the app more means:
- More journal entries (free - stored locally)
- More chat messages (costs API tokens)
- Better context (makes responses more relevant)

Typical costs remain low ($2-5/month for regular users) because Mood Leaf sends compressed context, not full journal history.
...
That's it! Mood Leaf will automatically detect the mood and themes.

### Can I use voice to journal?

Yes! Tap the microphone icon to speak your entry. Mood Leaf will transcribe it for you.

### What does Mood Leaf do with my journal entries?
...
Mood Leaf marks entries as significant when they contain important life context like:
...
This helps Mood Leaf remember what matters to you.

---

## Chatting with Your Guide

### How does my guide remember things about me?

Mood Leaf builds a **Life Context** from your journal entries over time:
...
This lets your guide give responses that understand YOUR story, not generic advice.

### Why does my guide use tentative language?

You'll notice your guide says things like "it seems like" or "I wonder if" rather than definitive statements. This is intentional because:
- Only YOU know your experience
- We don't want to tell you how you feel
- It leaves room for you to correct or clarify

### Can I ask my guide for advice?

Yes, but your guide will:
...
That's totally fine! Just start venting. Your guide will focus on validation and listening rather than problem-solving. You can say "I just need to vent" to make it clear.

### Why does my guide sometimes suggest stepping away?

Mood Leaf is designed to help you build independence, not dependency. If you've been chatting a while, it might gently suggest:
- Taking a break
- Journaling instead
...
From the entry detail screen, tap **"Talk about this"**. Your guide will have context about that entry in the chat.
...
**Everything stays on your device.** Mood Leaf uses local storage (AsyncStorage on iOS) which means:

- Your journal entries are saved in your phone's app storage
- Your life context is built and stored locally
- Your chat history lives only on your device
- Your health data (if enabled) is cached locally
- Your settings and preferences are local

**We have no servers.** We literally cannot see your data because it never leaves your phone.

### What exactly is stored on my device?

| Data Type | What's Stored | Where |
|-----------|---------------|-------|
| Journal entries | Full text, mood, topics, timestamps | Local storage |
| Life context | Extracted people, events, patterns | Local storage |
| Chat history | Your messages and AI responses | Local storage |
| Health data | Cached HealthKit snapshots | Local storage |
| Correlations | 90 days of mood + health data | Local storage |
| API key | Your Anthropic key (encrypted) | Secure storage |
| Preferences | Tone, notifications, settings | Local storage |

### What happens if I delete the app?

If you delete Mood Leaf:
- **All data is permanently deleted** from your device
- There's no backup unless you exported first
- We have no copy to restore

**Recommendation:** Use **Export Data** before deleting if you want to keep your history.

### Does Mood Leaf send my data to AI servers?

When you chat, Mood Leaf sends:
- Your current message
- Recent chat history (last ~6 messages)
- A **compressed summary** of your life context (not raw journal entries)
- Current health snapshot (if HealthKit enabled)

**What we DON'T send:**
- Full text of all your journal entries
- Your complete chat history
- Raw health data dumps
- Any identifying information beyond what you type

### How is data sent securely?

All communication with Claude API uses:
- HTTPS encryption in transit
- Direct connection to Anthropic's servers
- No intermediary servers or proxies
- No logging on our end (we have no servers)

### What does Anthropic do with my data?

According to Anthropic's privacy policy:
- API data is **not used for training** AI models
- Data is encrypted at rest
- Data is deleted after processing
- They don't sell or share your data
...
Export format is JSON, readable by any text editor.

### Can I delete all my data?

Yes. Go to **Settings** > **Delete All Data**. This:
...
For extra peace of mind, Mood Leaf offers **Secure Delete**:

1. Go to **Settings** > **Privacy** > **Secure Delete**
2. Enter the confirmation code shown
3. Tap **Permanently Delete**

Secure Delete:
- **Overwrites data multiple times** before deletion (3 passes)
- **Verifies** all data has been removed
- **Checks for remnants** and removes any stray data
- **Provides a report** confirming deletion

This makes data recovery virtually impossible, even with forensic tools.

### Can I delete just some of my data?

Yes. You can selectively delete:
- **Journal entries** - Settings > Privacy > Delete Journal Data
- **Chat history** - Settings > Privacy > Delete Chat History
- **Health data** - Settings > Privacy > Delete Health Data
- **Life context** - Settings > Life Context > Clear
- **Strategy favorites** - Strategies > Favorites > Clear All

Each deletion uses the same secure overwrite process.

### Is my API key secure?

Your API key is:
- Stored in iOS Secure Storage (Keychain)
- Never logged or displayed after entry
- Only sent directly to Anthropic's API
- Never shared with us or anyone else

### What if my phone is lost or stolen?

- If your phone has a passcode, your data is encrypted
- Mood Leaf has no remote access to wipe data
- Use Find My iPhone to remotely wipe if needed
- Consider enabling Face ID / Touch ID for extra security

### Can someone else access my Mood Leaf data?

Only if they:
1. Have physical access to your unlocked phone
2. Open the Mood Leaf app

Consider using iOS Screen Time to add an app-specific passcode if this concerns you.

---

## HealthKit Integration

### What health data does Mood Leaf use?

If you enable HealthKit, Mood Leaf can access:
...
Connecting HealthKit allows Mood Leaf to:
...
**Never.** Mood Leaf only describes what it observes:
...
Yes. Go to **Settings** > **HealthKit** > **Disable**. Mood Leaf works fine without it.
...
Over time, Mood Leaf tracks patterns between:
...
### Why does Mood Leaf show me my patterns?
...
Inspired by Brian Eno and Peter Schmidt's famous creative cards, Mood Leaf includes its own set of **Oblique Strategies** - unexpected prompts and perspectives to shift your thinking when you're stuck.

Unlike the original (designed for musicians), Mood Leaf's strategies are adapted for emotional wellbeing, creativity, and everyday life.

### What categories are available?

Mood Leaf offers strategies for different situations:
...
3. Read the strategy card
4. Sit with it - don't dismiss too quickly
5. Tap for another if needed
...
### Can I save my favorite strategies?

Yes! Tap the heart icon to save a strategy. Access saved strategies in **Strategies** > **Favorites**.

### Can I suggest new strategies?

We'd love that! Shake the device to send feedback, or email us with your suggestions.

---

## Personalization

### How do I change my guide's tone?
...
### Can my guide remember my preferences?

Yes! If you tell your guide things like:
...
If you express thoughts of self-harm or suicide, Mood Leaf will immediately:
...
### Does Mood Leaf report me to anyone?

**No.** Mood Leaf does not contact anyone, report to authorities, or share your information. All crisis resources are provided for YOU to use if you choose.

### Is Mood Leaf appropriate for serious mental health issues?

Mood Leaf can be a helpful companion alongside professional treatment, but it's **not a replacement** for:
- Therapy
- Psychiatric care
- Crisis intervention
- Medical treatment
...
### Which devices is Mood Leaf available on?

Currently iOS (iPhone and iPad). Android support is planned.

### Does Mood Leaf work offline?
...
If your question isn't answered here, try asking your guide directly in the chat - it knows a lot about how it works!
